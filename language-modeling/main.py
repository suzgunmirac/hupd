...
from language_modeling_data import preprocess_dataset_for_language_modeling
...
class DataTrainingArguments:
    ...
    data_dir: Optional[str] = field(
        default=None,
        metadata={"help": "Patent data directory"},
    )
    ...
    conditional: bool = field(
        default=False,
        metadata={"help": "Metadata-conditional language modeling"},
    )
...
def main():
    ...
    # Load patents dataset and tokenizer
    ...
    # Preprocess data
    preprocess_dataset_for_language_modeling
    datasets, tokenizer = preprocess_dataset_for_language_modeling(
        datasets, tokenizer, conditional=data_args.conditional)

    # Column names for language modeling
